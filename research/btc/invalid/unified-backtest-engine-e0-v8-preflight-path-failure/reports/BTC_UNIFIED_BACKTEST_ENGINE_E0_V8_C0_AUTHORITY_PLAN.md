# BTC unified backtest engine E0-v8: exact C0 authority boundary
...
contracts. E0-v8 owns only precise nested inherited pointers that apply to C0; it does not claim a
...
future-path predicate rejects hyphenated and underscored planned C0-C6 names, including authority,
...
frozen. On failure, archive v8 and use a new ID. No implementation occurs in E0-v8. E1-v15, E2,
