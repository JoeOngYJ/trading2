#!/usr/bin/env python3
"""Independent, fail-closed validation for E0-v12's C0-only design."""
...
ID = "btc-unified-backtest-engine-e0-v12-c0-authority-boundary"
CONTRACT = ROOT / "research/btc/contracts/btc-unified-backtest-engine-e0-v12-c0-authority-boundary.json"
INTERFACE = ROOT / "research/btc/specs/btc-backtest-c0-authority-interface-e0-v12.json"
OBLIGATIONS = ROOT / "research/btc/specs/btc-backtest-c0-inherited-obligations-e0-v12.json"
BUNDLE = ROOT / "research/btc/candidates/unified-backtest-engine-e0-v12-c0-design/pre-review-bundle-manifest.json"
REVIEWS = [
    ROOT / "research/btc/reviews/btc-unified-backtest-engine-e0-v12-boundary-review.json",
    ROOT / "research/btc/reviews/btc-unified-backtest-engine-e0-v12-validator-review.json",
]
...
EXPECTED_RECORD_CONSTRAINTS = {
 "C0AuthorityRef":["recursively_immutable"], "ContextAuthorityRef":["recursively_immutable"], "C0FileRef":["recursively_immutable"],
 "C0Manifest":["recursively_immutable","component_id_is_C0","contains_exactly_one_file_for_each_C0FileRole","files_unique_by_path_and_role","authorities_exactly_equal_c0_manifest_authorities_table_in_declared_order","authorities_unique_by_path_and_role","has_no_dependency_acceptances","manifest_digest_matches_declared_digest_domain"],
 "RunContext":["recursively_immutable","partition_start_strictly_before_partition_end","matches_run_context_projection_table_exactly","all_retyped_authorities_preserve_path_role_size_sha256_exactly","run_context_digest_matches_declared_digest_domain"],
 "RunSpec":["recursively_immutable","run_spec_digest_matches_declared_digest_domain","mandate_id_maps_to_exact_mandate_authority","scenario_id_maps_to_exact_scenario_authority_row_mode_latency","authority_fields_match_runspec_authority_field_roles_table","selection_is_in_allowed_mandate_adapter_modes","partition_start_strictly_before_partition_end"],
...
EXPECTED_FUTURE_BOUNDARY={"C0":"authority_manifest_registry_and_RunContext_design_only","C1":"deferred_unresolved_accounting_ledger","C2":"deferred_unresolved_candle_execution","C3":"deferred_unresolved_L2_execution","C4":"deferred_unresolved_atomic_pair_execution","C5":"deferred_unresolved_controls","C6":"deferred_unresolved_integration_and_reporting"}
EXPECTED_GATES=["canonical_JSON_rejects_duplicate_keys_and_nonfinite_numbers","all_authority_bindings_verify","exact_public_API_registry_types_compatibility_projection_and_digest_domains_verify","C0_input_and_C0_C6_context_authorities_have_distinct_exact_consumers","exact_nested_C0_obligation_registry_verifies","failure_findings_have_exact_unique_owner_probe_mapping","complete_bundle_exact_path_role_size_digest_mapping_verifies","full_contract_interface_obligation_semantic_snapshots_are_pinned_after_structural_checks","whole_repository_future_path_scan_uses_exact_v12_whitelist","two_separate_bound_independent_review_artifacts_pass","no_implementation_or_economic_evidence_was_created_or_opened","only_no_trade_is_actionable"]
EXPECTED_REVIEW_FINDINGS=["scope_is_C0_only_and_downstream_is_unresolved","public_API_registry_authority_and_selection_compatibility_are_exact","authority_types_exact_manifest_closure_and_digest_domains_are_complete","RunContext_projection_is_field_enumerated_and_complete","C0_obligation_subset_is_exact_without_downstream_closure","bundle_and_full_semantic_snapshots_are_bound","whole_repository_future_paths_fail_closed","no_prohibited_data_service_action_or_self_certified_review"]
...
EXPECTED_PROHIBITED=["any_C0_C6_implementation_before_E0_v12_pass","E1_v15_or_E2","historical_market_data_or_strategy_evaluation","sealed_2026_or_partial_OB0_data","credentials_network_exchange_database_NATS_Freqtrade_or_protected_soak_access","paper_or_live_trading","any_actionable_arm_other_than_no_trade"]
EXPECTED_SNAPSHOTS={
 "contract":"6d40d52e6a2bcabcd2409a213dce139437fced78df2d69ad8c095e082aa486f4",
 "interface":"d0e75521496a7352fbd1ee3c5c610987a1861d9734247b1a2e2399187ae46fd1",
 "obligations":"f73867d65d78567a0a2c1c6e34f68f37887814ea72d4c00630ebb37a79281d34"}
...
EXPECTED_FIELDS = {
 "C0AuthorityRef":{"path":fs("SafeRelativePath","repository",["C0"]),"sha256":fs("Sha256Hex","repository",["C0"]),"size_bytes":fs("NonNegativeInteger","repository",["C0"]),"role":fs("AuthorityRole","repository",["C0"])},
 "ContextAuthorityRef":{"path":fs("SafeRelativePath","C0",ALL),"sha256":fs("Sha256Hex","C0",ALL),"size_bytes":fs("NonNegativeInteger","C0",ALL),"role":fs("AuthorityRole","C0",ALL)},
 ...
 "C0Manifest":{"schema_version":fs("NonEmptyIdentifier","C0",["C0"]),"experiment_id":fs("NonEmptyIdentifier","C0",["C0"]),"component_id":fs("C0Literal","C0",["C0"]),"files":fs("List[C0FileRef]","C0",["C0"]),"authorities":fs("List[C0AuthorityRef]","C0",["C0"]),"created_at":fs("UtcTimestamp","C0",["C0"]),"manifest_digest":fs("Sha256Hex","C0",["C0"])},
 "RunContext":{name:fs(t,"C0",ALL,n) for name,t,n in [
  ("run_context_digest","Sha256Hex",False),("run_spec_id","NonEmptyIdentifier",False),("run_spec_digest","Sha256Hex",False),("run_spec_registry","ContextAuthorityRef",False),("run_spec_registry_digest","Sha256Hex",False),("mandate_id","MandateId",False),("mandate","ContextAuthorityRef",False),("adapter_id","AdapterId",False),("execution_mode","ExecutionMode",False),("scenario_id","ScenarioId",False),("scenario_row_digest","Sha256Hex",False),("latency_ms","LatencyMilliseconds",False),("source_manifest","ContextAuthorityRef",False),("rule_manifest","ContextAuthorityRef",False),("margin_manifest","ContextAuthorityRef",False),("settings","ContextAuthorityRef",False),("scenario","ContextAuthorityRef",False),("implementation_manifest_digest","Sha256Hex",False),("partition_start","UtcTimestamp",False),("partition_end","UtcTimestamp",False)]},
 "RunSpec":{name:fs(t,"repository",["C0"],n) for name,t,n in [
  ("run_spec_id","NonEmptyIdentifier",False),("run_spec_digest","Sha256Hex",False),("mandate_id","MandateId",False),("mandate","C0AuthorityRef",False),("adapter_id","AdapterId",False),("execution_mode","ExecutionMode",False),("scenario_id","ScenarioId",False),("scenario_row_digest","Sha256Hex",False),("latency_ms","LatencyMilliseconds",False),("scenario","C0AuthorityRef",False),("source_manifest","C0AuthorityRef",False),("rule_manifest","C0AuthorityRef",False),("margin_manifest","C0AuthorityRef",False),("settings","C0AuthorityRef",False),("implementation_manifest","C0Manifest",False),("partition_start","UtcTimestamp",False),("partition_end","UtcTimestamp",False)]},
...
def validate_interface(d):
 ...
 run_context_fields=[f["name"] for f in types["RunContext"]["fields"]]
 projection=d.get("run_context_projection",[])
 if [r.get("output") for r in projection]!=run_context_fields: raise ValidationError("RunContext projection output drift")
 if any(set(r)!={"output","source"} or not isinstance(r["source"],str) or not r["source"] for r in projection): raise ValidationError("RunContext projection source drift")
 if len({r["source"] for r in projection})!=len(projection): raise ValidationError("RunContext projection source duplication")
 expected_roles=[{"field":"mandate","role":"mandate"},{"field":"scenario","role":"scenario_registry"},{"field":"source_manifest","role":"source_manifest"},{"field":"rule_manifest","role":"rule_manifest"},{"field":"margin_manifest","role":"margin_manifest"},{"field":"settings","role":"settings"}]
 if d.get("runspec_authority_field_roles")!=expected_roles: raise ValidationError("RunSpec authority role map drift")
 manifest_authorities=d.get("c0_manifest_authorities",[])
 expected_authorities=[
  {"path":"research/btc/contracts/btc-unified-backtest-engine-e0-v12-c0-authority-boundary.json","role":"c0_design_contract","sha256":"cb05d5ddcc7843882b1083633bd0bf0cdb948123c1debc1937afb9154e4a394b","size_bytes":6389},
  {"path":"research/btc/contracts/btc-unified-backtest-engine-e0-v1.json","role":"inherited_e0_v1_contract","sha256":"af23751e6ef08a4c0dc11eb33559b4d939ec38260ae2d3ae22fcb73237856c0e","size_bytes":30986},
  {"path":"research/btc/contracts/btc-unified-backtest-engine-e0-v2.json","role":"inherited_e0_v2_contract","sha256":"201bbaad8f1fb6e00efdc2b3c25d632d0d3da94d8b8521c2f92b37da29cde887","size_bytes":7121},
  {"path":"research/btc/contracts/btc-unified-backtest-engine-e0-v3-pair-close.json","role":"inherited_e0_v3_contract","sha256":"b0cea8cb6b35df31d51c7745a6b2ec1b3a4a3c6ac99f67c4d5db12a021057df1","size_bytes":17493},
  {"path":"research/btc/contracts/btc-unified-backtest-engine-e0-v4-lineage-recovery.json","role":"inherited_e0_v4_contract","sha256":"d8b2852e6ef1e1c5b32bbf585f64683751d95480f9c87f890408708b58b5407c","size_bytes":10243}]
 if manifest_authorities!=expected_authorities: raise ValidationError("C0 manifest authority closure drift")
 for ref in manifest_authorities:
  p=safe_path(ref["path"])
  if not p.is_file() or p.stat().st_size!=ref["size_bytes"] or digest_file(p)!=ref["sha256"]: raise ValidationError("C0 manifest authority bytes drift")
...
def validate_semantics(contract,interface,obligations):
 ...
 expected_roles=[
  {"path":"research/btc/reports/BTC_UNIFIED_BACKTEST_ENGINE_E0_V12_C0_AUTHORITY_PLAN.md","role":"c0_plan"},{"path":"research/btc/reports/BTC_UNIFIED_BACKTEST_ENGINE_E0_V12_C0_FAILURE_MATRIX.md","role":"c0_failure_matrix"},{"path":"research/btc/specs/btc-backtest-c0-authority-interface-e0-v12.json","role":"c0_interface_spec"},{"path":"research/btc/specs/btc-backtest-c0-inherited-obligations-e0-v12.json","role":"c0_obligation_registry"},{"path":"research/btc/contracts/btc-unified-backtest-engine-e0-v12-c0-authority-boundary.json","role":"c0_contract"},{"path":"scripts/validate_btc_unified_engine_e0_v12.py","role":"c0_validator"},{"path":"research/btc/tests/test_unified_engine_e0_v12.py","role":"c0_tests"}]
 ...
 expected_reviews=[{"path":"research/btc/reviews/btc-unified-backtest-engine-e0-v12-boundary-review.json","reviewer_id":"Jason","reviewer_role":"boundary_reviewer"},{"path":"research/btc/reviews/btc-unified-backtest-engine-e0-v12-validator-review.json","reviewer_id":"Harvey","reviewer_role":"validator_reviewer"}]
 ...
 if contract.get("schema_version")!=ID or contract.get("status")!="frozen_pending_independent_review": raise ValidationError("contract schema/status drift")
 expected_next={"on_fail":"stop_custom_C0_architecture_archive_E0_v12_and_plan_minimal_reference_backtester","on_pass":"freeze_separate_btc-backtest-authorities-c0-v1_synthetic_implementation_contract_only","still_prohibited":"C1_C6_E1_v15_E2_historical_strategy_2026_partial_OB0_network_credentials_protected_services_paper_live"}
 if contract.get("subsequent_phase_boundary")!=expected_next: raise ValidationError("subsequent boundary drift")
 if obligations.get("schema_version")!="btc-backtest-c0-inherited-obligations-e0-v12" or obligations.get("scope_rule")!="Exhaustive only for precisely selected C0-owned nested pointers; every other inherited economic obligation remains binding and unresolved.": raise ValidationError("obligation envelope drift")
 for label,value in (("contract",contract),("interface",interface),("obligations",obligations)):
  if digest_bytes(canonical(value))!=EXPECTED_SNAPSHOTS[label]: raise ValidationError(f"{label} semantic snapshot drift")

WHITELIST={"research/btc/reports/BTC_UNIFIED_BACKTEST_ENGINE_E0_V12_C0_AUTHORITY_PLAN.md","research/btc/reports/BTC_UNIFIED_BACKTEST_ENGINE_E0_V12_C0_FAILURE_MATRIX.md","research/btc/specs/btc-backtest-c0-authority-interface-e0-v12.json","research/btc/specs/btc-backtest-c0-inherited-obligations-e0-v12.json","research/btc/contracts/btc-unified-backtest-engine-e0-v12-c0-authority-boundary.json","scripts/validate_btc_unified_engine_e0_v12.py","research/btc/tests/test_unified_engine_e0_v12.py","research/btc/candidates/unified-backtest-engine-e0-v12-c0-design","research/btc/candidates/unified-backtest-engine-e0-v12-c0-design/pre-review-bundle-manifest.json"}
...
def scan_future():
 skipped={".git",".venv","node_modules","__pycache__",".mypy_cache",".pytest_cache"}
 for p in ROOT.rglob('*'):
  rel=p.relative_to(ROOT).as_posix()
  if any(part in skipped for part in p.relative_to(ROOT).parts) or '/invalid/' in f'/{rel}/': continue
