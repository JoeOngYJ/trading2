# E0-v5 failure-to-requirement matrix

This matrix preserves the negative E1-v4-v14 evidence and assigns each failure to one future
component and one independent probe family. It changes no historical candidate.

| Failure | Root cause | E0-v5 requirement | Owner | Independent probe |
|---|---|---|---|---|
...
| V14 incomplete implementation lineage | Rows bound one module rather than the complete implementation | Merkle-style manifest digest covers every accepted component and authority | C0/C5 | `M15_complete_lineage` |
...
The matrix is closed for E0-v5. Adding, removing or reassigning a failure, owner or probe requires a
