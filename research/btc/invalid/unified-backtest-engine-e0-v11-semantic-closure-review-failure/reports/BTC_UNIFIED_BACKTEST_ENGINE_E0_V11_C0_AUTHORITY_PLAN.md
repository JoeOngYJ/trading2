# BTC unified backtest engine E0-v11: exact C0 authority boundary
...
contracts. E0-v11 owns only precise nested inherited pointers that apply to C0; it does not claim a
...
frozen. On failure, archive v11 and use a new ID. No implementation occurs in E0-v11. E1-v15, E2,
