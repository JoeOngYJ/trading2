...
S=importlib.util.spec_from_file_location("e0v11","scripts/validate_btc_unified_engine_e0_v11.py")
M=importlib.util.module_from_spec(S); assert S.loader; S.loader.exec_module(M)

class E0V11Tests(unittest.TestCase):
 @classmethod
 ...
 def test_registry_and_authority_role_mutations_fail_semantically(self):
  ...
  x=copy.deepcopy(self.i);x['types']['AuthorityRef']['fields'][3]['type']='NonEmptyIdentifier';self.bad(i=x)
