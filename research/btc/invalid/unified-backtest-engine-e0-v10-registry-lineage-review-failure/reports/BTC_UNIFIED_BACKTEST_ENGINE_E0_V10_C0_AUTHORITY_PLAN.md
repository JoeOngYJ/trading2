# BTC unified backtest engine E0-v10: exact C0 authority boundary
...
contracts. E0-v10 owns only precise nested inherited pointers that apply to C0; it does not claim a
...
frozen. On failure, archive v10 and use a new ID. No implementation occurs in E0-v10. E1-v15, E2,
