#!/usr/bin/env python3
"""Independent, fail-closed validation for E0-v9's C0-only design."""
...
ID = "btc-unified-backtest-engine-e0-v9-c0-authority-boundary"
CONTRACT = ROOT / "research/btc/contracts/btc-unified-backtest-engine-e0-v9-c0-authority-boundary.json"
INTERFACE = ROOT / "research/btc/specs/btc-backtest-c0-authority-interface-e0-v9.json"
OBLIGATIONS = ROOT / "research/btc/specs/btc-backtest-c0-inherited-obligations-e0-v9.json"
BUNDLE = ROOT / "research/btc/candidates/unified-backtest-engine-e0-v9-c0-design/pre-review-bundle-manifest.json"
REVIEWS = [
    ROOT / "research/btc/reviews/btc-unified-backtest-engine-e0-v9-boundary-review.json",
    ROOT / "research/btc/reviews/btc-unified-backtest-engine-e0-v9-validator-review.json",
]
...
def validate_semantics(contract,interface,obligations):
 ...
 expected_roles=[
  {"path":"research/btc/reports/BTC_UNIFIED_BACKTEST_ENGINE_E0_V9_C0_AUTHORITY_PLAN.md","role":"c0_plan"},{"path":"research/btc/reports/BTC_UNIFIED_BACKTEST_ENGINE_E0_V9_C0_FAILURE_MATRIX.md","role":"c0_failure_matrix"},{"path":"research/btc/specs/btc-backtest-c0-authority-interface-e0-v9.json","role":"c0_interface_spec"},{"path":"research/btc/specs/btc-backtest-c0-inherited-obligations-e0-v9.json","role":"c0_obligation_registry"},{"path":"research/btc/contracts/btc-unified-backtest-engine-e0-v9-c0-authority-boundary.json","role":"c0_contract"},{"path":"scripts/validate_btc_unified_engine_e0_v9.py","role":"c0_validator"},{"path":"research/btc/tests/test_unified_engine_e0_v9.py","role":"c0_tests"}]
 ...
 expected_reviews=[{"path":"research/btc/reviews/btc-unified-backtest-engine-e0-v9-boundary-review.json","reviewer_id":"Jason","reviewer_role":"boundary_reviewer"},{"path":"research/btc/reviews/btc-unified-backtest-engine-e0-v9-validator-review.json","reviewer_id":"Harvey","reviewer_role":"validator_reviewer"}]
...
WHITELIST={"research/btc/reports/BTC_UNIFIED_BACKTEST_ENGINE_E0_V9_C0_AUTHORITY_PLAN.md","research/btc/reports/BTC_UNIFIED_BACKTEST_ENGINE_E0_V9_C0_FAILURE_MATRIX.md","research/btc/specs/btc-backtest-c0-authority-interface-e0-v9.json","research/btc/specs/btc-backtest-c0-inherited-obligations-e0-v9.json","research/btc/contracts/btc-unified-backtest-engine-e0-v9-c0-authority-boundary.json","scripts/validate_btc_unified_engine_e0_v9.py","research/btc/tests/test_unified_engine_e0_v9.py","research/btc/candidates/unified-backtest-engine-e0-v9-c0-design/pre-review-bundle-manifest.json"}
