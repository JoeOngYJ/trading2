...
Identity: `btc-reference-fill-accounting-r1-v2`. Frozen before implementation. Action `no_trade`.
...
rounding source values. Use a fresh Decimal Context(prec=80, ROUND_HALF_EVEN). No rounding or
...
Supersedes rejected R1-v1: precision 50 failed a mixed-scale fixture. With at most 10000
events and 18-digit inputs, inventory is below 1e22 and equity/notional below 2e40;
products have at most 24 fractional places. At most 65 significant digits are needed,
so precision 80 preserves exact arithmetic. Add the four-fill reviewer regression and
a 10000-event mixed-scale Fraction reconciliation before acceptance. Original literals stay frozen.
