# R2-v1 archived breakout arithmetic replay

Identity `btc-archived-breakout-reconciliation-r2-v1`. Frozen before archived trade-row access.
...
event prices, quantities and references must fit R1-v2's <=18 total digits and <=12 fractional
...
Use accepted R1-v2 with initial cash 1000 separately for each scenario. Each archived trade becomes
